...
"""
獨立測試 ROI 路徑修復腳本
直接導入 data_models.py 避免依賴問題
"""

import sys
from pathlib import Path

# 直接添加 app/models 目錄到 Python 路徑
...
def test_standalone_roi_fix():
    ...
    component = data_models.ComponentInfo(
...
if __name__ == "__main__":
    try:
        success = test_standalone_roi_fix()
        if success:
            print("\n✅ 所有測試通過！ROI 路徑修復成功。")
            sys.exit(0)
        else:
